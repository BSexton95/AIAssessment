...
Maze::Maze()
{
	...
	TileKey map[Maze::HEIGHT][Maze::WIDTH] = {
		...
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, _, _, _, w },
		{ w, _, _, _, w, w, w, _, _, _, _, _, _, _, _, _, _, _, _, w, w, w, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, g, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, a2, _, _, w, w, w, w, _, _, w, w, w, _, _, w, w, w, _, _, _, _, a1, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		...
		{ w, _, w, w, w, _, _, _, _, _, _, _, w, _, w, _, _, _, _, _, _, _, _, w, w, w, _, w },
		{ w, _, w, w, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, w, w, _, w },
		{ w, _, w, w, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, w, w, _, w },
		{ w, _, _, w, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, w, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w },
	};
...
Maze::Tile Maze::createTile(int x, int y, TileKey key)
{
	...
	case TileKey::AGENTFLEEING: {
		...
		tile.cost = 1.0f;
		//Create a new agent
		Agent* agent2 = new Agent(position.x, position.y, "Agent2", 200, 200);
